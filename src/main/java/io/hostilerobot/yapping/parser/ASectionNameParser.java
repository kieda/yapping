...
import io.hostilerobot.yapping.ast.ASectionName;
import io.hostilerobot.yapping.parser.advancer.*;
import io.hostilerobot.yapping.util.CharBiPredicate;
import io.hostilerobot.yapping.util.CharPredicate;
import io.hostilerobot.yapping.util.SmallCharSequence;
...
public class ASectionNameParser implements AParser<CharSequence> {
    ...
    //'io.hostilerobot.yapping.parser.ASectionNameParser.SectionNameDAG1' is not within its bound; should extend
    // 'io.hostilerobot.sealedenum.SealedEnum<io.hostilerobot.yapping.parser.ASectionNameParser.SectionNameDAG1>'
